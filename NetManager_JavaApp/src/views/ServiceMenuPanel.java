...
public class ServiceMenuPanel extends JPanel {
    ...
    private void chooseImage() {
        ...
        if (returnValue == JFileChooser.APPROVE_OPTION) {
            ImageIcon icon = new ImageIcon(new ImageIcon(fileChooser.getSelectedFile().getPath()).getImage().getScaledInstance(80, 80, Image.SCALE_SMOOTH));
